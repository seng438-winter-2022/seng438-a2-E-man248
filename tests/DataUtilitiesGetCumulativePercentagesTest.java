...
public class DataUtilitiesGetCumulativePercentagesTest
{
	 ...
	 *  - There is only one item in data
	 */		
	@Test
	public void getCumulativePercentagesOnOneItemOfValueZero()
	{
		try
		{
			//setup
		    ...
		    //exercise
		    KeyedValues result = DataUtilities.getCumulativePercentages(data);
		    Assert.assertEquals("Expected Zero", 0, result.getValue(0).doubleValue(), .000000001d);
		}
	    catch (Exception e)
	    {
	 ...
	 */		
	@Test
	public void getCumulativePercentagesOnOneItemOfValueNotZero()
	{
		try
		{
			//setup
		    ...
		    //exercise
		    KeyedValues result = DataUtilities.getCumulativePercentages(data);
		    Assert.assertEquals("Expected 1.0", 1.0, result.getValue(0).doubleValue(), .000000001d);
		}
	    catch (Exception e)
	    {
	    	Assert.fail("Expected Zero");
